...
class Media extends BaseModel
{
    ...
    private $shortMediaPath = '/ddmedia/';
    ...
    {
        return "{$this->getPathToMediaFiles()}$file";
    }
    ...
    private function getPathToMediaFiles(): string
    {
        if ($this->isAlternativeImageUrlConfigured()) {
            ...
            $mediaPath = $this->shortMediaPath;
        } else {
            $basePath = getShopBasePath();
            $mediaPath = $this->_sMediaPath;
        }
        return rtrim($basePath, '/') . $mediaPath;
    }
    ...
    {
        return (string)Registry::getConfig()->getConfigParam(self::ALTERNATIVE_IMAGE_DIRECTORY_PARAMETER);
    }
}
