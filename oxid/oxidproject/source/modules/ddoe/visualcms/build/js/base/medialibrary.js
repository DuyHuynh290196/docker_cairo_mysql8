...
+function ( $ )
{
                        ...
                        ddh.confirm( ddh.translate( 'DD_MEDIA_REMOVE_CONFIRM' ), function ()
                            {
                                ...
                                $.get( actionLink + 'cl=ddoevisualcmsmedia&fnc=remove&id[]=' + deleteIDs.join( '&id[]=' ), function ()
                                    {
                                        $item.each( function ()
                                            {
                                                $( this ).parent().remove();
    ...
    MediaLibrary.prototype._loadMediaContent = function ( $dialog )
    {
        ...
        $.get( actionLink + 'cl=ddoevisualcmsmedia', function ( html )
            {
                ...
                $( '.dd-media', $dialog ).dropzone(
                    {
                        url: actionLink + 'cl=ddoevisualcmsmedia&fnc=upload',
                        parallelUploads: 10,
    ...
    MediaLibrary.prototype._loadMoreMediaContent = function ( page )
    {
        ...
        $.get( actionLink + 'cl=ddoevisualcmsmedia&fnc=moreFiles&start=' + start, function ( data )
            {
