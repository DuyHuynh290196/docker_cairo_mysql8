...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'discount_list.tpl', 1, false),array('modifier', 'oxaddslashes', 'discount_list.tpl', 111, false),array('function', 'oxmultilang', 'discount_list.tpl', 56, false),)), $this); ?>
                ...
                <div class="r1">
                    <div class="b1">
                        <input class="listedit" type="text" size="5" maxlength="128" name="where[oxdiscount][oxsort]"
                               value="<?php echo $this->_tpl_vars['where']['oxdiscount']['oxsort']; ?>
">
                    </div>
                </div>
            </td>
...
">
    ...
    <tr>
            ...
            <td class="listheader " height="15" align="center"><div class="listitemfloating"><a href="Javascript:top.oxid.admin.setSorting( document.search, 'oxdiscount', 'oxsort', 'asc');document.search.submit();" class="listheader"> <?php echo smarty_function_oxmultilang(array('ident' => 'GENERAL_SORT'), $this);?>
 </a></div></td>
...
<?php if ($this->_tpl_vars['listitem']->oxdiscount__oxactive->value == 1): ?> active<?php endif; ?>" height="15"><div class="listitemfloating">&nbsp;</a></div></td>
            <td valign="top" class="<?php echo $this->_tpl_vars['listclass']; ?>
" height="15" align="center"><div class="listitemfloating">&nbsp;<a href="Javascript:top.oxid.admin.editThis('<?php echo $this->_tpl_vars['listitem']->oxdiscount__oxid->value; ?>
');" class="<?php echo $this->_tpl_vars['listclass']; ?>
"><?php echo $this->_tpl_vars['listitem']->oxdiscount__oxsort->value; ?>
</a></div></td>
            <td valign="top" class="<?php echo $this->_tpl_vars['listclass']; ?>
...
">
            <?php if (! $this->_tpl_vars['readonly']): ?>
                <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "include/discount_list_item_actions.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
            <?php endif; ?>
