...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'category_list.tpl', 1, false),array('modifier', 'oxaddslashes', 'category_list.tpl', 114, false),array('function', 'oxmultilang', 'category_list.tpl', 51, false),)), $this); ?>
...
">
                            <?php if (! $this->_tpl_vars['readonly']): ?>
                                <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "include/category_list_item_actions.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
                            <?php endif; ?>
