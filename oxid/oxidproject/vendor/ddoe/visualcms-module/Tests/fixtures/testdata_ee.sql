...
#
INSERT IGNORE INTO `oxactions2article` (`OXID`, `OXSHOPID`, `OXACTIONID`, `OXARTID`, `OXSORT`) VALUES
...
INSERT IGNORE INTO `oxmanufacturers` (`OXID`, `OXMAPID`, `OXSHOPID`, `OXACTIVE`, `OXICON`, `OXTITLE`, `OXSHORTDESC`, `OXTITLE_1`, `OXSHORTDESC_1`, `OXTITLE_2`, `OXSHORTDESC_2`, `OXTITLE_3`, `OXSHORTDESC_3`, `OXSHOWSUFFIX`) VALUES
...
# Data for promotions
#
INSERT IGNORE INTO `oxactions` (`OXID`, `OXSHOPID`, `OXSORT`, `OXTYPE`, `OXTITLE`, `OXTITLE_1`, `OXTITLE_2`, `OXTITLE_3`, `OXLONGDESC`, `OXLONGDESC_1`, `OXLONGDESC_2`, `OXLONGDESC_3`, `OXACTIVE`, `OXACTIVEFROM`, `OXACTIVETO`) VALUES
...
#
INSERT IGNORE INTO `oxcategories2shop` (`OXSHOPID`, `OXMAPOBJECTID`) VALUES
  (1, 1), (1, 2), (1, 3), (1, 4), (1, 5);

INSERT IGNORE INTO `oxarticles2shop` (`OXSHOPID`, `OXMAPOBJECTID`) VALUES
  (1, 1), (1, 2), (1, 3);

INSERT IGNORE INTO `oxmanufacturers2shop` (`OXSHOPID`, `OXMAPOBJECTID`) VALUES
  (1, 901), (1, 902);