  ...
  <table cellspacing="0" cellpadding="0" border="0" width="98%">
      ...
      <td valign="top" class="edittext">
        ...
        <table cellspacing="0" cellpadding="0" border="0">
          [{block name="admin_article_extend_form"}]
              ...
              [{oxhasrights object=$edit field='oxweight' readonly=$readonly}]
              <tr>
                <td class="edittext">
                  [{oxmultilang ident="ARTICLE_EXTEND_WEIGHT"}]
                </td>
                <td class="edittext">
                  <input type="text" class="editinput" size="3" maxlength="[{$edit->oxarticles__oxweight->fldmax_length}]" name="editval[oxarticles__oxweight]" value="[{$edit->oxarticles__oxweight->value}]">[{oxmultilang ident="ARTICLE_EXTEND_WEIGHT_UNIT"}]
              ...
              <tr>
                ...
                <td class="edittext">
                  [{oxhasrights object=$edit field='oxlength' readonly=$readonly}]
                    [{oxmultilang ident="ARTICLE_EXTEND_LENGTH"}]&nbsp;<input type="text" class="editinput" size="3" maxlength="[{$edit->oxarticles__oxlength->fldmax_length}]" name="editval[oxarticles__oxlength]" value="[{$edit->oxarticles__oxlength->value}]">[{oxmultilang ident="ARTICLE_EXTEND_DIMENSIONS_UNIT"}]
                  [{/oxhasrights}]

                  [{oxhasrights object=$edit field='oxwidth' readonly=$readonly}]
                    [{oxmultilang ident="ARTICLE_EXTEND_WIDTH"}]&nbsp;<input type="text" class="editinput" size="3" maxlength="[{$edit->oxarticles__oxlength->fldmax_width}]" name="editval[oxarticles__oxwidth]" value="[{$edit->oxarticles__oxwidth->value}]">[{oxmultilang ident="ARTICLE_EXTEND_DIMENSIONS_UNIT"}]
                  [{/oxhasrights}]

                  [{oxhasrights object=$edit field='oxheight' readonly=$readonly}]
                    [{oxmultilang ident="ARTICLE_EXTEND_HEIGHT"}]&nbsp;<input type="text" class="editinput" size="3" maxlength="[{$edit->oxarticles__oxlength->fldmax_height}]" name="editval[oxarticles__oxheight]" value="[{$edit->oxarticles__oxheight->value}]">[{oxmultilang ident="ARTICLE_EXTEND_DIMENSIONS_UNIT"}]
                  [{/oxhasrights}]
              ...
              <tr>
                ...
                <td class="edittext">
                  [{oxhasrights object=$edit field='oxunitquantity' readonly=$readonly}]
                    <input type="text" class="editinput" size="10" maxlength="[{$edit->oxarticles__oxunitquantity->fldmax_length}]" name="editval[oxarticles__oxunitquantity]" value="[{$edit->oxarticles__oxunitquantity->value}]" [{include file="help.tpl" helpid=article_unit}]>
                  [{/oxhasrights}]

                  [{oxhasrights object=$edit field='oxunitname' readonly=$readonly}]
              ...
              [{oxhasrights object=$edit field='oxexturl' readonly=$readonly}]
              <tr>
                <td class="edittext">
                  [{oxmultilang ident="ARTICLE_EXTEND_EXTURL"}]
                </td>
                <td class="edittext">
                  <input type="text" class="editinput" size="40" maxlength="[{$edit->oxarticles__oxexturl->fldmax_length}]" name="editval[oxarticles__oxexturl]" value="[{$edit->oxarticles__oxexturl->value}]">
                  [{oxinputhelp ident="HELP_ARTICLE_EXTEND_EXTURL"}]
                </td>
              </tr>
              [{/oxhasrights}]

              [{oxhasrights object=$edit field='oxurldesc' readonly=$readonly}]
              <tr>
                <td class="edittext">
              ...
              <tr>
                ...
                <td class="edittext">
                  [{oxhasrights object=$edit field='oxbprice' readonly=$readonly}]
                    <input type="text" class="editinput" size="8" maxlength="[{$edit->oxarticles__oxbprice->fldmax_length}]" name="editval[oxarticles__oxbprice]" value="[{$edit->oxarticles__oxbprice->value}]">
                  [{/oxhasrights}]
                  [{oxinputhelp ident="HELP_ARTICLE_EXTEND_BPRICE"}]
                  [{oxhasrights object=$edit field='oxtprice' readonly=$readonly}]
                    &nbsp;[{oxmultilang ident="ARTICLE_EXTEND_TPRICE"}] <input type="text" class="editinput" size="8" maxlength="[{$edit->oxarticles__oxtprice->fldmax_length}]" name="editval[oxarticles__oxtprice]" value="[{$edit->oxarticles__oxtprice->value}]">
                  [{/oxhasrights}]
                  [{oxinputhelp ident="HELP_ARTICLE_EXTEND_TPRICE"}]
                </td>
              </tr>

              [{oxhasrights object=$edit field='oxfile' readonly=$readonly}]
              <tr>
                <td class="edittext">
              ...
              [{oxhasrights object=$edit field='oxquestionemail' readonly=$readonly}]
              <tr>
                <td class="edittext">
              ...
              <tr>
                <td colspan="2">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      [{oxhasrights object=$edit field='oxnonmaterial' readonly=$readonly}]
                      ...
                      <td class="edittext">
                        ...
                        <input class="edittext" type="checkbox" name="editval[oxarticles__oxnonmaterial]" value='1' [{if $edit->oxarticles__oxnonmaterial->value == 1}]checked[{/if}] [{if $oxparentid}]readonly disabled[{/if}]>
                        [{oxinputhelp ident="HELP_ARTICLE_EXTEND_NONMATERIAL"}]
                      </td>
                      [{/oxhasrights}]


                      [{oxhasrights object=$edit field='oxissearch' readonly=$readonly}]
                      <td class="edittext" width="120">
                        [{oxmultilang ident="ARTICLE_EXTEND_ISSEARCH"}]
                      </td>
                      <td class="edittext">
                        <input class="edittext" type="hidden" name="editval[oxarticles__oxissearch]" value='0'>
                        <input class="edittext" type="checkbox" name="editval[oxarticles__oxissearch]" value='1' [{if $edit->oxarticles__oxissearch->value == 1}]checked[{/if}]>
              ...
              <tr>
                <td colspan="2">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      [{oxhasrights object=$edit field='oxfreeshipping' readonly=$readonly}]
                      <td class="edittext" width="140">
                      ...
                      <td class="edittext">
                        ...
                        <input class="edittext" type="checkbox" name="editval[oxarticles__oxfreeshipping]" value='1' [{if $edit->oxarticles__oxfreeshipping->value == 1}]checked[{/if}] [{if $oxparentid}]readonly disabled[{/if}]>
                        [{oxinputhelp ident="HELP_ARTICLE_EXTEND_FREESHIPPING"}]
                      </td>
                      [{/oxhasrights}]

                      [{oxhasrights object=$edit field='oxblfixedprice' readonly=$readonly}]
                      <td class="edittext" width="120">
                          [{oxmultilang ident="ARTICLE_EXTEND_BLFIXEDPRICE"}]
                      </td>
                      <td class="edittext">
                        <input class="edittext" type="checkbox" name="editval[oxarticles__oxblfixedprice]" value='1' [{if $edit->oxarticles__oxblfixedprice->value == 1}]checked[{/if}]>
                ...
                <td colspan="2">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      [{oxhasrights object=$edit field='oxisconfigurable' readonly=$readonly}]
                      <td class="edittext" width="140">
              ...
              <tr>
                  <td colspan="2">
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                              [{oxhasrights object=$edit field='oxshowcustomagreement' readonly=$readonly}]
                              <td class="edittext" width="140">
                                  [{oxmultilang ident="ARTICLE_EXTEND_SHOWCUSTOMAGREEMENT"}]
                              </td>
                              <td class="edittext">
                                  <input class="edittext" type="hidden" name="editval[oxarticles__oxshowcustomagreement]" value='0'>
    ...
    <!-- Anfang rechte Seite -->
      ...
      <td valign="top" class="edittext" align="left" width="55%" style="table-layout:fixed">
        ...
        <input type="button" value="[{oxmultilang ident="GENERAL_ASSIGNCATEGORIES"}]" class="edittext" onclick="JavaScript:showDialog('&cl=article_extend&aoc=1&oxid=[{$oxid}]');">
