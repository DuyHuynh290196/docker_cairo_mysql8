[{if $listitem->blIsDerived && !$oViewConf->isMultiShop()}]
    <a href="Javascript:top.oxid.admin.unassignThis('[{ $listitem->oxdelivery__oxid->value }]');" class="unasign" id="una.[{$_cnt}]" title="" [{include file="help.tpl" helpid=item_unassign}]></a>
[{/if}]
