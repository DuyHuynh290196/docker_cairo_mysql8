...
<ul>
    ...
    <li class="sep">
        <a href="[{$oConfig->getShopURL()|cat:'?cl=mallstart&fnc=chshp&shp='|cat:$oViewConf->getActiveShopId()|cat:'&lang='|cat:$editlanguage}]"
           data-shop-id="[{$oViewConf->getActiveShopId()}]"
