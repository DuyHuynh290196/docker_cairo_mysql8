...
<colgroup>
    [{block name="admin_roles_felist_colgroup"}]
        <col width="98%"><col width="2%">
    [{/block}]
</colgroup>
<tr class="listitem">
    [{block name="admin_roles_felist_filter"}]
...
<tr>
    [{block name="admin_roles_felist_sorting"}]
        <td class="listheader first" height="15" colspan="2">&nbsp;<a href="Javascript:top.oxid.admin.setSorting( document.search, 'oxroles', 'oxtitle', 'asc');document.search.submit();" class="listheader">[{ oxmultilang ident="ROLES_LIST_TITLE" }]</a></td>
    [{/block}]
</tr>
...
[{foreach from=$mylist item=listitem}]
    ...
    <tr id="row.[{$_cnt}]">
    [{block name="admin_roles_felist_item"}]
...
{   parent.parent.sShopTitle   = "[{$actshopobj->oxshops__oxname->getRawValue()|oxaddslashes}]";
    ...
    parent.parent.sMenuSubItem = "[{ oxmultilang ident="mxferoles" }]";
