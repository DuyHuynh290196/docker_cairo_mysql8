...
{
    var oForm = top.document.getElementById('navigation').contentWindow.adminnav.document.getElementById( "search" );
    if (oForm) {
        ...
        // selecting shop
        top.document.getElementById('navigation').contentWindow.adminnav.selectShop( sID );
    }
}
    ...
    <tr id="row.[{$_cnt}]">
        [{block name="admin_shop_list_item"}]
            ...
            [{if $listitem->getId() == $oxid}]
                <script>top.oxid.admin.reloadHeader('[{$oxid}]');</script>
