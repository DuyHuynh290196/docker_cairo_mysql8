 ...
 *
 */
class ZendDiskCacheConnector implements \OxidEsales\Eshop\Application\Model\Contract\CacheConnectorInterface
{
    /**
    ...
    {
        if (!self::isAvailable()) {
            throw oxNew(\OxidEsales\Eshop\Core\Exception\StandardException::class, EXCEPTION_NOZENDDISKCACHE);
        }
    }
