...
namespace OxidEsales\EshopEnterprise\Internal\Transition\Adapter\TemplateLogic;

/**
 * Class HasRightsLogic
 */
class HasRightsLogic
{
     ...
     * @return string|null
     */
    public function hasRights(array $params, string $content = null, bool &$repeat = false)
    {
