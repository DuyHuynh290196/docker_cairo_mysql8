<h1 class="page-header">Test module for controller routing vendor 2 - [{$the_module_message}]</h1>

<form action="[{$oViewConf->getSelfActionLink()}]" name="MyModuleControllerAction" method="post" role="form">
    <div>
        [{$oViewConf->getHiddenSid()}]
        <input type="hidden" name="cl" value="vendor2_controllerrouting_mymodulecontroller">
