...
REPLACE INTO `oxvendor` (`OXID`,            `OXMAPID`, `OXSHOPID`, `OXACTIVE`, `OXTITLE`,                     `OXSHORTDESC`,                       `OXTITLE_1`,                   `OXSHORTDESC_1`,                          `OXSHOWSUFFIX`) VALUES
                       ...
                       ('testdistributor9', 110,       1,            1,         'www.de_distributor šÄßüл',    'www.de_distributor description',    'some_en_distributor šÄßüл',   '',                                        0);
...
REPLACE INTO `oxvoucherseries` (`OXID`,        `OXMAPID`, `OXSHOPID`, `OXSERIENR`,           `OXSERIEDESCRIPTION`,      `OXDISCOUNT`, `OXDISCOUNTTYPE`, `OXBEGINDATE`,         `OXENDDATE`,          `OXALLOWSAMESERIES`, `OXALLOWOTHERSERIES`, `OXALLOWUSEANOTHER`, `OXMINIMUMVALUE`, `OXCALCULATEONCE`) VALUES
                              ('testcoupon1',  101,       1,           'Test coupon 1 šÄßüл', 'Test coupon 1 desc šÄßüл', 10.00,       'absolute',       '2008-01-01 00:00:00', '2030-01-01 00:00:00', 1,                   1,                    1,                   75.00,            1),
                              ('testcoupon2',  102,       1,           'Test coupon 2 šÄßüл', 'Test coupon 2 desc šÄßüл', 5.00,        'percent',        '2008-01-01 00:00:00', '2030-01-01 00:00:00', 0,                   0,                    0,                   75.00,            1),
                              ('testvoucher1', 103,       1,           '1 Coupon šÄßüл',      '1 Description šÄßüл',      5.00,        'absolute',       '2007-01-01 00:00:00', '2030-12-31 00:00:00', 1,                   1,                    1,                   10.00,            1),
                              ('testvoucher2', 104,       1,           '2 Coupon šÄßüл',      '2 Coupon šÄßüл',           3.00,        'absolute',       '2009-01-01 00:00:00', '2030-10-10 00:00:00', 1,                   1,                    1,                   25.00,            0),
                              ('testvoucher3', 105,       1,           '3 Coupon šÄßüл',      '3 Coupon šÄßüл',           15.00,       'percent',        '2007-12-31 00:00:00', '2029-12-31 00:00:00', 0,                   0,                    0,                   100.00,           1),
                              ('testvoucher4', 106,       1,           '4 Coupon šÄßüл',      '4 Coupon šÄßüл',           50.00,       'percent',        '2008-01-01 00:00:00', '2030-01-01 00:00:00', 0,                   0,                    0,                   45.00,            1),
                              ('testvoucher5', 107,       1,           '5 Coupon šÄßüл',      '5 Coupon šÄßüл',           30.00,       'percent',        '2008-01-01 00:00:00', '2030-01-01 00:00:00', 0,                   0,                    0,                   300.00,           1),
                              ('testvoucher6', 108,       1,           '6 Coupon šÄßüл',      '6 Coupon šÄßüл',           20.00,       'percent',        '2008-01-01 00:00:00', '2030-01-01 00:00:00', 0,                   0,                    0,                   300.00,           1),
                              ('testvoucher7', 109,       1,           '7 Coupon šÄßüл',      '7 Coupon šÄßüл',           25.00,       'absolute',       '2008-01-01 00:00:00', '2030-01-01 00:00:00', 0,                   0,                    0,                   300.00,           1),
                              ('testvoucher8', 110,       1,           '8 Coupon šÄßüл',      '8 Coupon šÄßüл',           54.00,       'absolute',       '2008-01-01 00:00:00', '2030-01-01 00:00:00', 0,                   0,                    0,                   300.00,           1),
                              ('testvoucher9', 111,       1,           '[last] Coupon šÄßüл', '9 Coupon šÄßüл',           64.00,       'absolute',       '2008-01-01 00:00:00', '2030-01-01 00:00:00', 0,                   0,                    0,                   300.00,           1);
...
REPLACE INTO `oxnewssubscribed` (`OXID`,                       `OXSHOPID`, `OXUSERID`,  `OXSAL`, `OXFNAME`,   `OXLNAME`,      `OXEMAIL`,            `OXSUBSCRIBED`) VALUES
                               ...
                               ('15947a85ab4658ce7.11111111',  1,         'testuser1',  'Mr',    'UserName',  'UserSurname',  'example_test@oxid-esales.dev', '2008-02-05 14:46:44'),
                               ('15947a85ab4658ce7.22222222',  1,         'testuser2',  'Mr',    'UserName',  'UserSurname',  'example_test@oxid-esales.dev', '2008-02-05 14:46:44'),
                               ('15947a85ab4658ce7.33333333',  1,         'testuser3',  'Mr',    'UserName',  'UserSurname',  'example_test@oxid-esales.dev', '2008-02-05 14:46:44'),
                               ('15947a85ab4658ce7.44444444',  1,         'testuser4',  'Mr',    'UserName',  'UserSurname',  'example_test@oxid-esales.dev', '2008-02-05 14:46:44'),
                               ('15947a85ab4658ce7.55555555',  1,         'testuser5',  'Mr',    'UserName',  'UserSurname',  'example_test@oxid-esales.dev', '2008-02-05 14:46:44'),
                               ('15947a85ab4658ce7.66666666',  1,         'testuser6',  'Mr',    'UserName',  'UserSurname',  'example_test@oxid-esales.dev', '2008-02-05 14:46:44'),
                               ('15947a85ab4658ce7.77777777',  1,         'testuser7',  'Mr',    'UserName',  'UserSurname',  'example_test@oxid-esales.dev', '2008-02-05 14:46:44'),
                               ('15947a85ab4658ce7.88888888',  1,         'testuser8',  'Mr',    'UserName',  'UserSurname',  'example_test@oxid-esales.dev', '2008-02-05 14:46:44'),
                               ('15947a85ab4658ce7.99999999',  1,         'testuser9',  'Mr',    'UserName',  'UserSurname',  'example_test@oxid-esales.dev', '2008-02-05 14:46:44'),
                               ('15947a85ab4658ce7.11111110',  1,         'testuser10', 'Mr',    'UserName',  'UserSurname',  'example_test@oxid-esales.dev', '2008-02-05 14:46:44');
...
REPLACE INTO `oxdiscount` (`OXID`,           `OXMAPID`, `OXSHOPID`, `OXACTIVE`, `OXTITLE`,                          `OXTITLE_1`,                       `OXAMOUNT`, `OXAMOUNTTO`, `OXPRICETO`, `OXPRICE`, `OXADDSUMTYPE`, `OXADDSUM`, `OXITMARTID`, `OXITMAMOUNT`, `OXITMMULTIPLE`, `OXSORT`) VALUES
                         ('testcatdiscount', 101,       1,            1,         'discount for category [DE] šÄßüл', 'discount for category [EN] šÄßüл', 1,          999999,       0,           0,        'abs',          5,          '',           0,             0,               100),
                         ('testartdiscount', 102,       1,            1,         'discount for product [DE] šÄßüл',  'discount for product [EN] šÄßüл',  0,          0,            999999,      100,      '%',            10,         '',           0,             0,               110),
                         ('testdiscount1',   103,       1,            1,         '1 DE test discount šÄßüл',         '[last] EN test discount šÄßüл',    0,          999999,       999999,      0,        'abs',          5,          '',           0,             0,               120),
                         ('testdiscount2',   104,       1,            0,         '2 DE test discount šÄßüл',         '3 EN test discount šÄßüл',         0,          0,            0,           0,        'abs',          0,          '',           0,             0,               130),
                         ('testdiscount3',   105,       1,            0,         '3 DE test discount šÄßüл',         '2 EN test discount šÄßüл',         0,          0,            0,           0,        'abs',          0,          '',           0,             0,               140),
                         ('testdiscount4',   106,       1,            0,         '4 DE test discount šÄßüл',         '4 EN test discount šÄßüл',         0,          0,            0,           0,        'abs',          0,          '',           0,             0,               150),
                         ('testdiscount5',   107,       1,            0,         '[last] DE test discount šÄßüл',    '1 EN test discount šÄßüл',         1,          999999,       0,           0,        'abs',          10,         '',           0,             0,               160),
                         ('testitmdiscount', 108,       1,            1,         'Itm discount [DE] šÄßüл',          'Itm discount [EN] šÄßüл',          5,          999999,       0,           0,        'itm',          0,          '1003',       1,             0,               170);
...
REPLACE INTO `oxcontents` (`OXID`,         `OXLOADID`,         `OXSHOPID`, `OXSNIPPET`, `OXTYPE`, `OXACTIVE`, `OXACTIVE_1`, `OXTITLE`,                   `OXCONTENT`,                `OXTITLE_1`,                 `OXCONTENT_1`,                    `OXCATID`,                    `OXFOLDER`,           `OXTIMESTAMP`) VALUES
                         ...
                         ('testcontent5', 't9testcontent',     1,          0,           3,        0,          0,           'T5 [DE] content šÄßüл',     '',                         'T1 [EN] content šÄßüл',     '',                               '30e44ab834ea42417.86131097', 'CMSFOLDER_USERINFO', '2008-01-01 00:00:01'),
...
DELETE FROM `oxgroups` WHERE `OXID` = '36944b76defac5622.13882269';
DELETE FROM `oxobject2group` WHERE `OXGROUPSID` = '36944b76defac5622.13882269';
