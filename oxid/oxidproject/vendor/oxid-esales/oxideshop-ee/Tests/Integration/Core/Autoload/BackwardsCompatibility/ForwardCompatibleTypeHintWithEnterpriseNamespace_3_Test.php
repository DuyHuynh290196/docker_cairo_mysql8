...
class ForwardCompatibleTypeHintWithEnterpriseNamespace_3_Test extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testForwardCompatibleTypeHintWithEnterpriseNamespace()
    {
        ...
        $object = oxNew(\OxidEsales\EshopEnterprise\Application\Model\Article::class);
        /**
