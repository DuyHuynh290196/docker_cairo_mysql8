...
class ForwardCompatibleTypeHintWithEnterpriseNamespace_7_Test extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testForwardCompatibleTypeHintWithEnterpriseNamespace()
    {
        ...
        $object = new \OxidEsales\EshopEnterprise\Application\Model\Article();
        /**
