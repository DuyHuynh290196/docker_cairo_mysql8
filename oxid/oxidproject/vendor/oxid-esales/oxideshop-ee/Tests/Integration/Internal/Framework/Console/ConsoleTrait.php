...
use OxidEsales\EshopEnterprise\Internal\Framework\Console\Executor;
use OxidEsales\EshopEnterprise\Internal\Transition\Adapter\EnterpriseShopAdapter;
...
trait ConsoleTrait
{
    ...
    {
        $executor = new Executor($application, new ConsoleOutput(), $commandsProvider, new EnterpriseShopAdapter());
