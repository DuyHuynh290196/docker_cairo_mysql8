...
namespace PHPSTORM_META {
    ...
    $STATIC_METHOD_TYPES = array(
        oxNew('') => array(
            'oxAdminDetails' instanceof \OxidEsales\EshopProfessional\Application\Controller\Admin\AdminDetailsController,
            'oxSysRequirements' instanceof \OxidEsales\EshopProfessional\Core\SystemRequirements,
        ),
    );
}
