...
class ForwardCompatibleTypeHintWithProfessionalNamespace_3_Test extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $object = oxNew(\OxidEsales\EshopProfessional\Application\Model\Article::class);
        /**
