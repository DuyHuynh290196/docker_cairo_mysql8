...
class ForwardCompatibleTypeHintWithProfessionalNamespace_7_Test extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $object = new \OxidEsales\EshopProfessional\Application\Model\Article();
        /**
